...
public class RainResponseHead implements org.apache.thrift.TBase<RainResponseHead, RainResponseHead._Fields>, java.io.Serializable, Cloneable, Comparable<RainResponseHead> {
  ...
  public RainResponseHead setCode(long code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public RainResponseHead setMessage(String message) {
    this.message = message;
    return this;
  }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(code);
