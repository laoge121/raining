...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2017-09-20")
public class InvokeService {
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_invokeJava(long callTime, String code, String cname, String methodName, byte param) throws TException
    {
      ...
      args.setMethodName(methodName);
      args.setParam(param);
      sendBase("invokeJava", args);
    }

    public String recv_invokeJava() throws TException
    {
      invokeJava_result result = new invokeJava_result();
      receiveBase(result, "invokeJava");
      if (result.isSetSuccess()) {
        return result.success;
      }
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "invokeJava failed: unknown result");
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class invokeJava_call extends org.apache.thrift.async.TAsyncMethodCall {
      private long callTime;
      private String code;
      ...
      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("invokeJava", org.apache.thrift.protocol.TMessageType.CALL, 0));
        invokeJava_args args = new invokeJava_args();
        args.setCallTime(callTime);
        args.setCode(code);
        args.setCname(cname);
      ...
      public String getResult() throws TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_invokeJava();
      }
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("invokeJava", new invokeJava());
      return processMap;
    }
    ...
    public static class invokeJava<I extends Iface> extends org.apache.thrift.ProcessFunction<I, invokeJava_args> {
      public invokeJava() {
        super("invokeJava");
      }

      public invokeJava_args getEmptyArgsInstance() {
        return new invokeJava_args();
      }
      ...
      public invokeJava_result getResult(I iface, invokeJava_args args) throws TException {
        invokeJava_result result = new invokeJava_result();
        result.success = iface.invokeJava(args.callTime, args.code, args.cname, args.methodName, args.param);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class invokeJava<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, invokeJava_args, String> {
      public invokeJava() {
        super("invokeJava");
      }
      ...
      public void start(I iface, invokeJava_args args, AsyncMethodCallback<String> resultHandler) throws TException {
        iface.invokeJava(args.callTime, args.code, args.cname, args.methodName, args.param,resultHandler);
      }
    }
  ...
  public static class invokeJava_args implements org.apache.thrift.TBase<invokeJava_args, invokeJava_args._Fields>, java.io.Serializable, Cloneable, Comparable<invokeJava_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("invokeJava_args");
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new invokeJava_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new invokeJava_argsTupleSchemeFactory());
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public invokeJava_args(invokeJava_args other) {
      __isset_bitfield = other.__isset_bitfield;
      this.callTime = other.callTime;
      if (other.isSetCode()) {
        this.code = other.code;
    ...
    public invokeJava_args deepCopy() {
      return new invokeJava_args(this);
    }
    ...
    public invokeJava_args setCallTime(long callTime) {
      this.callTime = callTime;
      setCallTimeIsSet(true);
      return this;
    }
    ...
    public invokeJava_args setCode(String code) {
      this.code = code;
      return this;
    }
    ...
    public invokeJava_args setCname(String cname) {
      this.cname = cname;
      return this;
    }
    ...
    public invokeJava_args setMethodName(String methodName) {
      this.methodName = methodName;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof invokeJava_args)
        return this.equals((invokeJava_args)that);
      return false;
    }

    public boolean equals(invokeJava_args that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(invokeJava_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("invokeJava_args(");
      boolean first = true;
    ...
    private static class invokeJava_argsStandardSchemeFactory implements SchemeFactory {
      public invokeJava_argsStandardScheme getScheme() {
        return new invokeJava_argsStandardScheme();
      }
    }

    private static class invokeJava_argsStandardScheme extends StandardScheme<invokeJava_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, invokeJava_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, invokeJava_args struct) throws TException {
        struct.validate();
    ...
    private static class invokeJava_argsTupleSchemeFactory implements SchemeFactory {
      public invokeJava_argsTupleScheme getScheme() {
        return new invokeJava_argsTupleScheme();
      }
    }

    private static class invokeJava_argsTupleScheme extends TupleScheme<invokeJava_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, invokeJava_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetCallTime()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, invokeJava_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(5);
        if (incoming.get(0)) {
          struct.callTime = iprot.readI64();
  ...
  public static class invokeJava_result implements org.apache.thrift.TBase<invokeJava_result, invokeJava_result._Fields>, java.io.Serializable, Cloneable, Comparable<invokeJava_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("invokeJava_result");

    private static final org.apache.thrift.protocol.TField SUCCESS_FIELD_DESC = new org.apache.thrift.protocol.TField("success", org.apache.thrift.protocol.TType.STRING, (short)0);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new invokeJava_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new invokeJava_resultTupleSchemeFactory());
    }
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(invokeJava_result.class, metaDataMap);
    }

    public invokeJava_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public invokeJava_result(invokeJava_result other) {
      if (other.isSetSuccess()) {
        this.success = other.success;
      }
    }

    public invokeJava_result deepCopy() {
      return new invokeJava_result(this);
    }
    ...
    public invokeJava_result setSuccess(String success) {
      this.success = success;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof invokeJava_result)
        return this.equals((invokeJava_result)that);
      return false;
    }

    public boolean equals(invokeJava_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(invokeJava_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("invokeJava_result(");
      boolean first = true;
    ...
    private static class invokeJava_resultStandardSchemeFactory implements SchemeFactory {
      public invokeJava_resultStandardScheme getScheme() {
        return new invokeJava_resultStandardScheme();
      }
    }

    private static class invokeJava_resultStandardScheme extends StandardScheme<invokeJava_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, invokeJava_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, invokeJava_result struct) throws TException {
        struct.validate();
    ...
    private static class invokeJava_resultTupleSchemeFactory implements SchemeFactory {
      public invokeJava_resultTupleScheme getScheme() {
        return new invokeJava_resultTupleScheme();
      }
    }

    private static class invokeJava_resultTupleScheme extends TupleScheme<invokeJava_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, invokeJava_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, invokeJava_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readString();
